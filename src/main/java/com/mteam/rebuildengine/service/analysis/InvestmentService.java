...
public interface InvestmentService {
    ...
    // (F-06/F-07/F-08 계산 로직 자체는 라이브 단건 조회와 동일). tradeActivityIndex(§8.17,
    // 2026-08-09 추가)는 "거래 활성도" 전용 — MarketService.getMarketAnalysis에 그대로 전달만 한다.
    InvestmentSnapshot computeSnapshot(BuildingEntity building, BuildingDataBundle bundle,
